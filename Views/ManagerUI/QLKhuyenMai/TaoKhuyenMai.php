                                            ...
                                            <div class="boxTable">
                                                <div style="display: flex; padding: 0rem 1rem 0rem 1rem; justify-content: space-around;">
                                                    <div style="padding-left: 1rem; margin-left: 25px;">
                                                        ...
                                                        <input id="Code" class="input" type="text" name="Code" style="width: 40rem" />
...
<script>
    ...
    function createKhuyenMai(Code, maCondition, SaleAmount, IsPublic, ExpirationTime) {
        var dataToSend = {
            Code: Code,
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data) {
                    console.log("Khuyến mãi được tạo thành công!");
                } else {
                    console.log("Đã xảy ra lỗi khi tạo Khuyến mãi!");
                }
            },
